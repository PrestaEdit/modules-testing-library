...
class BOBasePage extends CommonPage {
  ...
  constructor() {
    ...
    this.errorModalOpened = `${this.errorModal}.in`;
    this.errorModalCloseButton = `${this.errorModal} button`;
  ...
  async goToSubMenu(page, parentSelector, linkSelector) {
    ...
    if (await this.elementVisible(page, this.errorModalOpened, 1000)) {
      helper.addWarning(this, 'Modal closed');
      await page.click(this.errorModalCloseButton);
    }
  }
