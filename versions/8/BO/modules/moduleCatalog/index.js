...
class ModuleCatalog extends BOBasePage {
  ...
  constructor() {
    ...
    this.moduleBloc = moduleTag => `div.module-item[data-tech-name='${moduleTag}']:not([style])`;
    this.actionsDropdownButton = moduleTag => `${this.moduleBloc(moduleTag)} button.dropdown-toggle`;
